...
export default function About() {
  return (
    <>
      <Head>
        <title>
          Sobre Web Acessível | Pedro Dias 
        </title>
      </Head>
      ...
      <article className={styles.content} >
        ...
        <a 
          href="https://www.cnmp.mp.br/portal/acessibilidade#:~:text=Acessibilidade%20pode%20ser%20definida%20como,e%20comunica%C3%A7%C3%A3o%2C%20bem%20como%20de" 
